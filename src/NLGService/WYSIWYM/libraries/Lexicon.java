package NLGService.WYSIWYM.libraries;
...
import NLGService.WYSIWYM.model.DTEdge;
import NLGService.WYSIWYM.model.DTNode;
import NLGService.WYSIWYM.model.DependencyTree;
import NLGService.WYSIWYM.model.Morph;
...
public class Lexicon 
{
	...
	// Language specification properties:
	...
	/** XML-tag to identify a literal part of the label to insert before the property value. This label will only be added if the resource has such a property*/
	public static final String PRE_LABEL = "preLabel";
	/** XML-tag to identify a literal part of the label to insert after the property value. This label will only be added if the resource has such a property*/
	 ...
	 * @deprecated use NLGProperties instead
	 */
	@Deprecated
	public static final String PATH = "/Users/thomas/Documents/workspace/ourSpacesLocal/web/NLGTest/lexicon/";

	@Deprecated
	public static final String CLASS_SPEC_PATH = "/Users/thomas/Documents/workspace/ourSpacesLocal/web/NLGTest/lexicon/ClassSpec/";

	// MrT server path:
//	public static final String PATH = "../webapps/ourspaces/NLGTest/lexicon/";
//	public static final String CLASS_SPEC_PATH = "../webapps/ourspaces/NLGTest/lexicon/ClassSpec/";
    ...
    {	//check this property and its inverse
    	if (new File(NLGProperties.getString("lexiconPropertySpecPath") + p.getLocalName() + ".xml").exists())
    		return true;
    	OntProperty inverse = reader.getInverse(p);
    	if ((inverse != null) && new File(NLGProperties.getString("lexiconPropertySpecPath") + inverse.getLocalName() + ".xml").exists())
    		return true;
    	return false;
    }
    ...
    {	//open the dependencytree-file for this property
   	...
   	//	InputStream input = getClass().getClassLoader().getResourceAsStream(PATH + fileName);
   		InputStream input = new FileInputStream(NLGProperties.getString("lexiconPropertySpecPath") + fileName);
    	readFile(input);
    	input.close();
    	return trans;
    }
