...
public class SummationAnchor extends Anchor
{
	...
	public SummationAnchor(List<SGEdge> list)
	{
		...
		// Set the property aggregated:
    	if (!edges.isEmpty()) {
			SGEdge sgEdge = edges.get(0);
			setAggregatedProperty(sgEdge.getNamespace() + sgEdge.getLabel()); 
		}
	...
	public void setAggregatedProperty(String aggregatedProperty) {
