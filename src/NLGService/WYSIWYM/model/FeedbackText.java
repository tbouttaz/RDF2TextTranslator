...
public class FeedbackText
{
	...
	/**
	 * Get anchorInfo from an anchor ID: look in the list of anchorString for the one that have that anchor
	 * @param nodeID
	 * @return
	 */
	public AnchorString getAnchorStringsFromNode(String nodeID) {
		Collection<AnchorString> anchorStrings = new ArrayList<AnchorString>();

		if (nodeID != null) {
			for (AnchorString anchorString : list) {
				if (anchorString.getAnchor() != null && anchorString.getAnchor().getNode() != null && nodeID.equals(anchorString.getAnchor().getNode().getID())) {
					return anchorString;
				}
			}			
		}
...
//	public Collection<AnchorString> getAnchorStringsFromNode(String nodeID) {
//		Collection<AnchorString> anchorStrings = new ArrayList<AnchorString>();
//
//		if (nodeID != null) {
//			for (AnchorString anchorString : list) {
//				if (anchorString.getAnchor() != null && anchorString.getAnchor().getNode() != null && nodeID.equals(anchorString.getAnchor().getNode().getID())) {
//					anchorStrings.add(anchorString);
//				}
//			}			
//		}
//
