...
public class SGDoubleNode extends SGNode implements DatatypeNode
{
	...
	/** @see NLGService.WYSIWYM.model.DatatypeNode#getDatatype()
	 */
	...
	/** @see NLGService.WYSIWYM.model.DatatypeNode#getValue()
	 */
	...
	/** @see NLGService.WYSIWYM.model#DatatypeNode.setValue(Object)
	 */
	...
	/** @see NLGService.WYSIWYM.model.DatatypeNode#getOldValue()
	 */
