package NLGService.WYSIWYM.ontology;
...
import NLGService.WYSIWYM.model.QueryValue;
...
import NLGService.WYSIWYM.util.SPARQLException;
import NLGService.liber.InstanceData;
...
public class OntologyWriter
{
	...
	/**	PolicyGrid Provenance ontology URI */
	public static final String ResourceURI = "http://www.policygrid.org/provenance-generic.owl#"; 
...
///////////////******************** SPARQL CREATION ****************/////////////
	...
	/**	Creates a query that finds all statements that have the given id as their subject, and statements about labels of objects 
	 *  (if they have one).
	 *	Example:
	 *  CONSTRUCT { <http://openprovenance.org/ontology#e535f7fb-7322-446b-8106-9f211a8cff3c> ?predicate ?object.
	 *  ?object rdfs:label ?label.}
	 *  Where {
	 *    <http://openprovenance.org/ontology#e535f7fb-7322-446b-8106-9f211a8cff3c> ?predicate ?object.
	 *    Optional{ ?object rdfs:label ?label.}
	 *  }
	 *	@param id Sesame ID
	 *	@return String SPARQL
	 */
	public static String getDescriptionAndLabelsQuery(String id){
		StringBuffer sb = new StringBuffer();
		sb.append("PREFIX rdfs:<http://www.w3.org/2000/01/rdf-schema#>");
		sb.append("CONSTRUCT { <" + id +"> ?predicate ?object . ?object rdfs:label ?label .}");
		sb.append("WHERE { <" + id + "> ?predicate ?object . OPTIONAL{ ?object rdfs:label ?label.} }");
		return sb.toString();
	}

	/**	Creates a query that finds all statements that have the given id as their subject, and statements about types of related resources 
	 *	Example:
	 *  CONSTRUCT { <http://openprovenance.org/ontology#e535f7fb-7322-446b-8106-9f211a8cff3c> ?predicate ?object.
	 ...
	 *	@return String SPARQL
	 */
	public static String getDescriptionAndTypesQuery(String id){
		StringBuffer sb = new StringBuffer();
		sb.append("PREFIX rdf:<http://www.w3.org/1999/02/22-rdf-syntax-ns#>");
		sb.append("CONSTRUCT { <" + id +"> ?predicate ?object . ?object rdf:type ?type .}");
		sb.append("WHERE { <" + id + "> ?predicate ?object . OPTIONAL{ ?object rdf:type ?type.} }");
		return sb.toString();
	}

	/**
	 * Create a SPARQL query to retrieve only the literal values of a resource, and the type of that resource (to know how to refer to that resource)
	 * @param id sesame ID of the resource
	 * @return
	 */
	public static String getLiteralValuesQuery(String id){
		StringBuffer sb = new StringBuffer();
		sb.append("PREFIX rdf:<http://www.w3.org/1999/02/22-rdf-syntax-ns#>");
		sb.append("CONSTRUCT { <" + id +"> ?predicate ?object . <" + id +"> rdf:type ?type . }");
		sb.append("WHERE { <" + id +"> rdf:type ?type . <" + id + "> ?predicate ?object . FILTER isLiteral(?object)}");
		return sb.toString();
	}

	/**
	 * Create a SPARQL query to retrieve the provenance of a resource (e.i. the process that used that resource)
	 * @param id
	 * @return
	 */
	public static String getProvenanceQuery(String id){
		StringBuffer sb = new StringBuffer();
		sb.append("PREFIX j.6:<http://openprovenance.org/ontology#> PREFIX j.5:<http://www.policygrid.org/provenance-generic.owl#> PREFIX rdf:<http://www.w3.org/1999/02/22-rdf-syntax-ns#>");
		sb.append("CONSTRUCT { <" + id +"> j.5:wasUsedByInfer ?process . <" + id +"> rdf:type ?type . }");
		sb.append("WHERE { ?usedEdge j.6:cause <" + id +"> . ?usedEdge j.6:effect ?process. <" + id +"> rdf:type ?type .}");
		return sb.toString();
	}
	
	/**
	 * Create a SPARQL query to retrieve the provenance of a resource. This query can be used for describing the provenance of different types of resources: artifact, process (TODO:or Agent))
	 * Depending on what type of opm:Edges are related to this resource, different properties will be inferred
	 * @param id
	 * @return
	 */
	public static String getInferredProvenanceQuery(String id){
		StringBuffer sb = new StringBuffer();
		sb.append("PREFIX j.6:<http://openprovenance.org/ontology#> PREFIX j.5:<http://www.policygrid.org/provenance-generic.owl#> PREFIX rdf:<http://www.w3.org/1999/02/22-rdf-syntax-ns#>");
		sb.append("Construct {");
		sb.append("<" + id +"> a ?resourceType.");
		
		sb.append("<" + id +"> j.5:controlledInfer ?processC.");
		sb.append("<" + id +"> j.5:wasControlledByInfer ?Agent.");
		
		sb.append("<" + id +"> j.5:generatedInfer ?artifactB .");
		sb.append("<" + id +"> j.5:wasGeneratedByInfer ?processB .");

		sb.append("<" + id +"> j.5:usedInfer ?process2.");
		sb.append("<" + id +"> j.5:wasUsedByInfer ?processA.");


		sb.append("?Agent a ?agentType.");
		sb.append("?artifactB a ?artifactType.");
		sb.append("?processA a ?processAType.");
		sb.append("?processB a ?processBType.");
		sb.append("?process2 a ?process2Type.");
		sb.append("?processC a ?processCType.");
		...
		// Infer "<" + id +"> j.5:wasControlledByInfer ?Agent." (subject is a Process)
		sb.append("Optional{");
		sb.append("?WasControlledByEdge a j.6:WasControlledBy .");
		sb.append("?WasControlledByEdge j.6:effect <" + id +"> .");
		sb.append("?WasControlledByEdge j.6:cause ?Agent .");
		sb.append("?Agent a ?agentType.");
		sb.append("}");

		// Infer "<" + id +"> j.5:controlledInfer ?processC." (subject is an Agent)
		sb.append("Optional{");
		sb.append("?WasControlledByEdge a j.6:WasControlledBy .");
		sb.append("?WasControlledByEdge j.6:cause <" + id +"> .");
		sb.append("?WasControlledByEdge j.6:effect ?processC .");
		sb.append("?processC a ?processCType.");
		sb.append("}");
		
		// Infer "<" + id +"> j.5:generatedInfer ?artifactB ." (subject is a Process)
		sb.append("Optional{");
		sb.append("?WasGeneratedByEdge a j.6:WasGeneratedBy .");
		sb.append("?WasGeneratedByEdge j.6:cause <" + id +"> .");
		sb.append("?WasGeneratedByEdge j.6:effect ?artifactB .");
		sb.append("?artifactB a ?artifactType.");
		sb.append("}");

		// Infer "<" + id +"> j.5:wasGeneratedByInfer ?processB ." (subject is an artifact)
		sb.append("Optional{");
		sb.append("?WasGeneratedByEdge2 a j.6:WasGeneratedBy .");
		sb.append("?WasGeneratedByEdge2 j.6:effect <" + id +"> .");
		sb.append("?WasGeneratedByEdge2 j.6:cause ?processB .");
		sb.append("?processB a ?processBType.");
		sb.append("}");

		// Infer "<" + id +"> j.5:wasUsedByInfer ?processA." (subject is an artifact)
		sb.append("Optional{");
		sb.append("?usedEdge a j.6:Used .");
		sb.append("?usedEdge j.6:cause <" + id +"> .");
		sb.append("?usedEdge j.6:effect ?processA .");
		sb.append("?processA a ?processAType.");
		sb.append("}");
		
		// Infer "<" + id +"> j.5:usedInfer ?process2." (subject is an process)
		sb.append("Optional{");
		sb.append("?usedEdge2 a j.6:Used .");
		sb.append("?usedEdge2 j.6:effect <" + id +"> .");
		sb.append("?usedEdge2 j.6:cause ?process2 .");
		sb.append("?process2 a ?process2Type.");
		sb.append("}");
	...
	/**
	 * Build a query constructing triples for the specified subject and predicate
	 * @param subjectID
	 * @param predicate
	 * @return
	 */
	public static String getDescriptionAndTypesQuery(String id, String predicate){
		StringBuffer sb = new StringBuffer();
		sb.append("PREFIX rdf:<http://www.w3.org/1999/02/22-rdf-syntax-ns#>");
		sb.append("CONSTRUCT { <" + id +"> <"+ predicate +"> ?object . ?object rdf:type ?type .}");
		sb.append("WHERE { <" + id + "> <"+ predicate +"> ?object . OPTIONAL{ ?object rdf:type ?type.} }");
	...
	// Build a query constructing triples for the specified subject and predicate, and a triple about the type of the subject 
//	public static StringBuffer getDescriptionAndTypesQuery(String subjectID, String predicate){
//		StringBuffer sb = new StringBuffer();
//		sb.append("PREFIX rdf:<http://www.w3.org/1999/02/22-rdf-syntax-ns#>");
//		sb.append("CONSTRUCT { <" + subjectID +"> <"+ predicate +"> ?object . <" + subjectID +"> rdf:type ?subjectType . ?object rdf:type ?objectType .}");
//		sb.append("WHERE { <" + subjectID + "> <"+ predicate +"> ?object . <" + subjectID +"> rdf:type ?subjectType . OPTIONAL{ ?object rdf:type ?objectType.} }");
//		return sb;
//	}


	/**
	 * Return every statements where the resource ID is the subject or the object, and the types of the related resources
	 * @param id ID of the resource
	 * @return
	 */
	public static String getFullDescriptionAndTypesQuery(String id){
		StringBuffer sb = new StringBuffer();
		sb.append("PREFIX rdf:<http://www.w3.org/1999/02/22-rdf-syntax-ns#>");
		sb.append("CONSTRUCT { <" + id +"> ?predicate ?object . ?object rdf:type ?type . ?subject ?predicate2 <" + id +"> .}");
		sb.append("WHERE { <" + id + "> ?predicate ?object . OPTIONAL{ ?object rdf:type ?type. ?subject ?predicate2  <http://www.policygrid.org/project.owl#0b84229a-11f3-4d21-a436-afa8d98a0a12> .} }");
		return sb.toString();
	}

	
	/**
	 * Get the Object of a statement from its subject and predicate
	 * @param subject
	 * @param predicate
	 * @return
	 */
	public static String getObject(String subject, String predicate) {
		StringBuffer sb = new StringBuffer();
		sb.append("SELECT ?object WHERE{ <" + subject + "> <" + predicate + "> " + "?object }");
		return sb.toString();
	}

	/**
	 * Get the Subject of a statement from its predicate and object
	 * @param predicate
	 * @param object
	 * @return
	 */
	public static String getSubject(String predicate, String object) {
		StringBuffer sb = new StringBuffer();
		sb.append("SELECT ?subject WHERE{ ?subject <" + predicate + "> <" + object + "> " + "}");
		return sb.toString();
	}
