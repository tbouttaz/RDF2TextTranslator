...
public class SesameReader
{
	...
	public static final String baseURI = NLGProperties.getString("sesameBaseURI");
	/**	Name of Sesame repository */
//	public static final String repository = "ourSpacesVRE2";
	public static final String repository = NLGProperties.getString("sesameRepository");

	/**	URL of Sesame server*/	
	public String sesame = NLGProperties.getString("sesameURL");	
	...
	public OntModel getJenaModel(String resourceID){
		...
		String sparqlQuery = OntologyWriter.getDescriptionAndTypesQuery(resourceID);
		return getJenaModelFromSparqlQuery(sparqlQuery);
	}

	public OntModel getJenaModelFromSparqlQuery(String sparqlQuery){
		
		try {
			GraphQuery query = connection.prepareGraphQuery(QueryLanguage.SPARQL, sparqlQuery);
			...
			ontModel = (OntModel) ontModel.read(in, baseURI);
			in.close();
